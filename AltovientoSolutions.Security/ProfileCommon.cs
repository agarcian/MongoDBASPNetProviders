...
namespace AltovientoSolutions.Security
{
    ...
    public class ProfileCommon : ProfileBase, IProfileCommon
    {
        ...
        [AltovientoSolutions.Security.ContextualSecurityAttribute]
        [SettingsAllowAnonymous(false)]
        public List<String> SecurityTokens { get { return base["SecurityTokens"] as List<String>; } set { base["SecurityTokens"] = value; } }
