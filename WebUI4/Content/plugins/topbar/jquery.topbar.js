...
(function ($) {
    $.fn.showTopbarMessage = function (options) {
        ...
        var overlayStyle = "height: " + options.height + ";filter: alpha(opacity=80);-moz-opacity: 0.8;-khtml-opacity: 0.8;opacity: 0.8;background-color: " + options.background + ";border-bottom: solid 5px " + options.borderColor + ";";
